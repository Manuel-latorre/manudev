...
const AboutMe = () => {
  return (
    <div className='flex flex-col gap-2 xl:w-[60%] w-[90%] mx-auto mt-32'>
        <div className='flex flex-col gap-2'>
            ...
            <p className='xl:w-[60%] w-[90%] text-zinc-200'>
            ...
            <div className='flex items-center gap-2'>
                <Dot/>
                <p className='text-zinc-200'>Actuálmente trabajo en <span><Link className='text-blue-200 font-medium' href={""}>Tualo</Link></span> y también como Freelance.</p>
            </div>
